        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAlbum = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Album = table.Column<Guid>(type: "TEXT", nullable: false),
                    Picture = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistOwners", x => new { x.PlaylistId, x.UserId });
                    table.ForeignKey(
                        name: "FK_PlaylistOwners_Playlists_PlaylistId",
                        column: x => x.PlaylistId,
                        principalTable: "Playlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistOwners_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongAuthors", x => new { x.SongId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongAuthors_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistOwners_PlaylistId_UserId",
                table: "PlaylistOwners",
                columns: new[] { "PlaylistId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistOwners_UserId",
                table: "PlaylistOwners",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistSongs_Order",
                table: "PlaylistSongs",
                column: "Order");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongAuthors_SongId_UserId",
                table: "SongAuthors",
                columns: new[] { "SongId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SongAuthors_UserId",
                table: "SongAuthors",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Songs_Name_Album",
                table: "Songs",
                columns: new[] { "Name", "Album" },
                unique: true);
